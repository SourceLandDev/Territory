...
internal static class MainCommand
{
    ...
    {
        // TODO：命令（暂未设计）
        DynamicCommandInstance instance = DynamicCommand.CreateCommand("ter", I18n.Translate(Thread.CurrentThread.CurrentCulture.Name, "territory.command.description"), CommandPermissionLevel.Any);
